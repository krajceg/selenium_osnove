...
public class BootstrapTablePage {
	...
	public WebElement getEditButtonByRow(int row) {
		return this.driver.findElements(By.className("update")).get(row);
	}
	...
	public List<WebElement> getRows() {
		return driver.findElement(By.className("table")).findElement(By.tagName("tbody")).findElements(By.tagName("tr"));		
	}
	
//	public WebElement getCell(int row, int column) {
//		return driver.findElement(By.xpath("//" + row + column));
//	}
}
